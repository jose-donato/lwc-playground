...
import {
	...
	type TooltipCrosshairLineData,
} from "./CrosshairLinePane";
import {
	type DeltaSingleTooltipData,
	type DeltaTooltipData,
	DeltaTooltipPaneView,
} from "./DeltaTooltipPane";
import {
	MultiTouchChartEvents,
	type MultiTouchInteraction,
} from "./MultiTouchChartEvents";
...
export class DeltaTooltipPrimitive implements ISeriesPrimitive<Time> {
	...
	attached(param: SeriesAttachedParameter<Time>): void {
		...
		// Disable chart handling while tooltip is active
	...
	detached(): void {
		...
		if (chart) {
			// Re-enable chart handling when detached
			chart.applyOptions({
				handleScroll: true,
				handleScale: true,
			});
